...
- (void)processCorners:(CGPoint)_c0 :(CGPoint)_c1 :(CGPoint)_c2 :(CGPoint)_c3 :(float)real_size :(float)f_x :(float)f_y :(float)c_x :(float)c_y {
    ...
    Point3f corners_3d[] = {
        Point3f(-real_size / 2, -real_size / 2, 0),
        Point3f(-real_size / 2,  real_size / 2, 0),
        Point3f( real_size / 2,  real_size / 2, 0),
        Point3f( real_size / 2, -real_size / 2, 0)
    };
    ...
    solvePnP(m_corners_3d, m_corners, m_camera_matrix, m_dist_coeff, rot_vec, tvec);
